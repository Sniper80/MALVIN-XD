...
cmd({
  ...
  try {
    _0x30d3fc("𝚂𝙽𝙸𝙿𝙴𝚁 IS 💑 Fetching couple profile pictures...*");
    ...
    if (_0x5d4b91) {
      await _0x552520.sendMessage(_0x556c44, {
        ...
        'caption': "𝚂𝙽𝙸𝙿𝙴𝚁 SUGGESTS: 👨 Male Couple Profile Picture"
      }, {
        'quoted': _0x51cf3f
      });
    }
    if (_0x5a1e4a) {
      await _0x552520.sendMessage(_0x556c44, {
        ...
        'caption': "𝚂𝙽𝙸𝙿𝙴𝚁 SUGGESTS: 👩 Female Couple Profile Picture"
      }, {
        'quoted': _0x51cf3f
      });
    }
